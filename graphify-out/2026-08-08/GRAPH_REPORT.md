# Graph Report - CanvasCLISwift  (2026-08-03)

## Corpus Check
- 118 files · ~107,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1704 nodes · 3572 edges · 84 communities (79 shown, 5 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 512 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0b1d9497`
...
1. `SyncEngine` - 56 edges
2. `APIClient` - 54 edges
3. `CalculatorViewModel` - 53 edges
4. `CanvasCore` - 51 edges
5. `AppSession` - 40 edges
6. `Credentials` - 38 edges
7. `DashboardView` - 36 edges
8. `MockData` - 31 edges
9. `CanvasData` - 26 edges
10. `CoursesViewModel` - 26 edges
...
Cohesion: 0.18
Nodes (10): APIClient, .baseURL, .token, URLSession, Credentials, CanvasStore, Bool, ModelContainer (+2 more)

### Community 1 - "CalculatorViewModel"
Cohesion: 0.08
Nodes (34): .body, SolveForMeTabView, .body, .gradeLetters, SolveResultView, .body, Binding, WhatIfRowView (+26 more)
...
Cohesion: 0.06
Nodes (41): FetchDescriptor, ModelContext, CanvasRepository, .context, Bool, Date, Int, ModelContainer (+33 more)
...
Cohesion: 0.19
Nodes (7): APIClientMessagingTests, URLSession, PaginationStub, Bool, Data, String, URLRequest
...
### Community 21 - ".body"
Cohesion: 0.32
Nodes (6): MainWindowBody, .body, Bool, Color, Double, Int
...
Cohesion: 0.06
Nodes (52): Codable, CodingKey, Decodable, Decoder, buildGradedItems(), MockData, Double, Int (+44 more)
...
Cohesion: 0.06
Nodes (43): Charts, ClosedRange, CalculatorInputs, CanvasRepository, Kind, awaitingGrade, feedback, recentlyGraded (+35 more)
...
Cohesion: 0.18
Nodes (7): .normalizedHost, String, CredentialsTests, RubricTests, AnnouncementSyncTests, ConcurrencyStressTests, XCTestCase

### Community 44 - "SyncEngine"
Cohesion: 0.10
Nodes (30): CustomStringConvertible, Error, Sendable, Date, String, EntityKind, announcements, assignments (+22 more)
...
Cohesion: 0.10
Nodes (23): ChangeDetector, PendingChange, SubmissionSnapshot, Bool, Date, Double, Int, Set (+15 more)
...
Cohesion: 0.27
Nodes (7): CourseDetailViewModel, .calculator, Bool, Date, GradeCalculator, Int, String
...
### Community 58 - "APIClientDemoTests"
Cohesion: 0.16
Nodes (6): Int, JSONDecoder, APIClientDemoTests, APIClientPaginationTests, URLSession, URLQueryItem

### Community 59 - "Text"
Cohesion: 0.12
Nodes (23): Bool, Double, String, Void, TermSandboxRail, .body, .footer, .header (+15 more)

### Community 60 - "AssignmentPredicatesTests"
Cohesion: 0.05
Nodes (40): .commentsSection, AssignmentFilter, all, graded, missing, upcoming, assignmentMatchesFilter(), isAssignmentMissing() (+32 more)

### Community 61 - "CanvasGradesApp"
Cohesion: 0.15
Nodes (15): App, CanvasGradesApp, .body, .preferredColorScheme, PopoverContent, .body, .coursesVM, ColorScheme (+7 more)
...
Cohesion: 0.13
Nodes (20): AssignmentRow, .body, .isHypothetical, CourseWorkspaceBody, CourseWorkspaceView, .body, GradesSandboxSplit, .actualCalculator (+12 more)
...
Cohesion: 0.09
Nodes (30): Context, NSObject, NSViewRepresentable, AttributedHTMLText, .attributed, .body, AttributedString, Coordinator (+22 more)

### Community 66 - "AnnouncementsViewModel"
Cohesion: 0.08
Nodes (30): AnnouncementsViewModel, .selected, Bool, Date, Int, String, AnnouncementsTabView, .body (+22 more)
...
Cohesion: 0.13
Nodes (14): .body, GradesTabView, .body, Void, ComingSoonView, .body, String, Int (+6 more)
...
### Community 71 - "View"
Cohesion: 0.10
Nodes (25): AssignmentsViewModel, .filteredRows, .instructorComments, .selectedRow, Row, .id, Bool, Date (+17 more)

### Community 72 - "DashboardView"
Cohesion: 0.12
Nodes (19): DashboardView, .awaitingRows, .body, .dashboardContent, .dotColors, .emptyState, .errorState, .feedbackRows (+11 more)
...
Cohesion: 0.16
Nodes (5): AppKit, CanvasData, CanvasUI, SwiftUI, WebKit

### Community 75 - "Foundation"
Cohesion: 0.12
Nodes (4): Foundation, ISO8601DateFormatter, CanvasDate, SwiftData

### Community 76 - "StalenessLabel"
Cohesion: 0.13
Nodes (14): CourseDetailBody, .body, CourseDetailView, .body, Int, .mainColumn, CalculatorView, Bool (+6 more)

### Community 77 - "DashboardViewModel"
Cohesion: 0.23
Nodes (10): CourseLedgerRow, DashboardViewModel, Bool, Color, Date, Double, Int, String (+2 more)
...
## Knowledge Gaps
- **404 isolated node(s):** `.isDemo`, `.hasCredentials`, `.coursesVM`, `Security`, `dashboard` (+399 more)
...
- **Why does `CanvasCore` connect `CanvasCore` to `StreamItem`, `GroupInfo`, `LedgerRowView`, `CanvasRepository`, `SwiftUI`, `Foundation`, `SyncEngine`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Foundation` connect `Foundation` to `APIClient`, `StreamItem`, `GroupInfo`, `LedgerRowView`, `CanvasRepository`, `SyncStub`, `SwiftUI`, `SyncEngine`, `.submissionChanges`, `.ids`, `CourseGradeSummary`, `CourseSettingsStore`, `APIError`, `MockData`, `.load`, `AssignmentPredicatesTests`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `SyncEngine` connect `SyncEngine` to `APIClient`, `AppSession`, `.makeRepo`, `SyncEngineCourseTests`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Are the 78 inferred relationships involving `Text` (e.g. with `.body` and `.body`) actually correct?**
  _`Text` has 78 INFERRED edges - model-reasoned connections that need verification._
- **Are the 20 inferred relationships involving `SyncEngine` (e.g. with `.testAnnouncementResyncPreservesReadAt()` and `.testCourseSyncPopulatesAnnouncements()`) actually correct?**
  _`SyncEngine` has 20 INFERRED edges - model-reasoned connections that need verification._
- **Are the 17 inferred relationships involving `APIClient` (e.g. with `.testConnection()` and `.wireEngine()`) actually correct?**
  _`APIClient` has 17 INFERRED edges - model-reasoned connections that need verification._
